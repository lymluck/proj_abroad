...
public class AppSettingsDialog implements Parcelable, DialogInterface.OnClickListener {
    ...
    public static class Builder {
         ...
         * PermissionUtil#hasPermissions(Context, String...)} in {@link
        ...
        public AppSettingsDialog build(String per_name) {
            mRationale = TextUtils.isEmpty(mRationale) ?
                    String.format(mContext.getString(R.string.rationale_ask_again), per_name) : mRationale;
            ...
            mPositiveButton = TextUtils.isEmpty(mPositiveButton) ?
                    mContext.getString(R.string.to_setting) : mPositiveButton;
            mNegativeButton = TextUtils.isEmpty(mNegativeButton) ?
                    mContext.getString(R.string.to_cancle) : mNegativeButton;
