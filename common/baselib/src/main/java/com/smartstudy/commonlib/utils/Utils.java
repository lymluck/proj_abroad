...
//    }
     ...
     * @param pgkName
     */
    public static void openApp(Activity context, String pgkName) {
    ...
    public static String getCacheUrl(String avatar, int width, int height) {
        return DisplayImageUtils.formatImgUrl(avatar, width, width);
    }
