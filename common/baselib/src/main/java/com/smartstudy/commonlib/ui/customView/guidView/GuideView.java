...
public class GuideView extends RelativeLayout {
    ...
    public void setDate(List<HoleBean> holeList) {
        ...
        mStrokeWidth = Math.max(Math.max(mBitmapRect.left, mBitmapRect.top), Math.max(ScreenUtils.getScreenWidth() -
                mBitmapRect.right, ScreenUtils.getScreenHeight() - mBitmapRect.bottom));
