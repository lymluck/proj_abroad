...
public class CrescentoImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (styledAttributes.hasValue(R.styleable.CrescentoImageView_tint_mode)) {
            if (styledAttributes.getInt(R.styleable.CrescentoImageView_tint_mode, 0) == TintMode.AUTOMATIC) {
