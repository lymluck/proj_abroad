package com.smartstudy.commonlib.ui.customview.transferimage.transfer;
...
import com.smartstudy.commonlib.ui.customview.transferimage.loader.NoneImageLoader;
import com.smartstudy.commonlib.ui.customview.transferimage.style.index.CircleIndexIndicator;
import com.smartstudy.commonlib.ui.customview.transferimage.style.progress.ProgressBarIndicator;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void checkConfig() {
        ...
        if (transConfig.getNowThumbnailIndex() >= transConfig.getSourceImageList().size()) {
