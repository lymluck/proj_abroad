...
import com.smartstudy.commonlib.ui.customView.transferImage.style.IProgressIndicator;
import com.smartstudy.commonlib.ui.customView.transferImage.style.view.TransferImage;
...
class EmptyThumState extends TransferState {
    ...
    public void transferLoad(final int position) {
        ...
        config.getImageLoader().showSourceImage(imgUrl, targetImage, new ImageLoader.SourceCallback() {
