...
public class CommonSearchPresenter implements CommonSearchContract.Presenter {
    ...
    @Override
    public void getHighSchools(int cacheType, String countryId, String keyword, int page, final int request_state, final String flag) {
        CommonSearchModel.getHighSchools(cacheType, countryId, keyword, page, new BaseCallback<String>() {
            @Override
    ...
    @Override
    public void getRankArt(int cacheType, String keyword, int page, final int request_state, final String flag) {
        CommonSearchModel.getArtRank(cacheType, keyword, page, new BaseCallback<String>() {
            @Override
            public void onErr(String errCode, String msg) {
                view.showTip(errCode, msg);
            }
            ...
            @Override
            public void onSuccess(String result) {
                List<RankTypeInfo.RankingsEntity> datas = JSON.parseArray(result, RankTypeInfo.RankingsEntity.class);
                if (datas != null) {
                    view.showResult(datas, request_state, flag);
                }
            }
        });
    }
