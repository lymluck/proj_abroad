...
import com.smartstudy.commonlib.ui.adapter.WheelAdapter;
...
public class WheelView extends View {
     ...
     */
    private int ITEM_OFFSET = (int) TEXT_SIZE / 5;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        TEXT_SIZE = a.getDimensionPixelSize(R.styleable.wheelview_textsize, 16);
        initData(context);
        a.recycle();
    }
    ...
    private void initData(Context context) {
        ...
        VALUE_TEXT_COLOR = context.getResources().getColor(R.color.app_main_color);
        ITEMS_TEXT_COLOR = context.getResources().getColor(R.color.app_text_color);
        scroller = new Scroller(context);
        ADDITIONAL_ITEM_HEIGHT = DensityUtils.dip2px(20.3f);
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(TEXT_SIZE + 4);
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFFFFF);
        }
    ...
    private String getTextItem(int index) {
        ...
        index %= count;
        return TextUtils.ellipsize(adapter.getItem(index), valuePaint, screenWidth - PADDING * 2, TextUtils.TruncateAt.END).toString();
    }
    ...
    private int getMaxTextLength() {
        ...
        for (int i = Math.max(currentItem - addItems, 0); i < Math.min(
            ...
            text = TextUtils.ellipsize(text, valuePaint, screenWidth - PADDING * 2, TextUtils.TruncateAt.END).toString();
            if (text != null
    ...
    // animation handler
    private WeakHandler animationHandler = new WeakHandler() {
