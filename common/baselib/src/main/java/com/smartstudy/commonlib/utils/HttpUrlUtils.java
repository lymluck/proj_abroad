...
public class HttpUrlUtils {
    ...
    public static final String URL_MYQA = "/personal/questions";  //获取我的问答列表
    public static final String URL_ADD_QUES = "/question";  //提问
    ...
    public static final String URL_ADD="/favorite/question/%1$s";
    public static final String URL_COLLECT="/collection/question/%1$s";
