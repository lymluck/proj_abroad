...
public class QuestionsModel {
    ...
    public static void getTeacherQa(final String teacherId, final int page,
                                    BaseCallback<String> callback) {
        RequestManager.getInstance().doGet(ParameterUtils.NETWORK_ELSE_CACHED, new BaseRequestConfig() {
            @Override
            public String getUrl() {
                return HttpUrlUtils.getUrl(HttpUrlUtils.URL_ALL_QUESTS);
            }
            ...
            public Map getParams() {
                ...
                map.put("page", page + "");
                map.put("answered", true + "");
                map.put("answeredCounsellorId", teacherId);
                return map;
            }
        }, callback);
    }
    ...
    public static void getRecommendQa(int cacheType, final int page, BaseCallback<String> callback) {
        RequestManager.getInstance().doGet(cacheType, new BaseRequestConfig() {
            @Override
            public String getUrl() {
                return HttpUrlUtils.getUrl(HttpUrlUtils.URL_RECOMMEND_QA);
            }
