...
public class GlideImageLoader implements ImageLoader {
    ...
    @Override
    public void showSourceImage(final String srcUrl, ImageView imageView, final SourceCallback sourceCallback) {
        ...
        DisplayImageUtils.displayImage(context, srcUrl, progressTarget);
    }
    ...
    public void loadThumbnailAsync(String thumbUrl, ImageView imageView, final ThumbnailCallback callback) {
        ...
        DisplayImageUtils.displayImage(context, thumbUrl, progressTarget);
    }
