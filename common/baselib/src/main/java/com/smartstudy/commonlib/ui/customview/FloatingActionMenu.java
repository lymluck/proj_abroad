...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = DensityUtils.dip2px(0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = DensityUtils.dip2px(0f);
    private int mLabelsVerticalOffset = DensityUtils.dip2px(0f);
    ...
    private int mLabelsPaddingTop = DensityUtils.dip2px(4f);
    private int mLabelsPaddingRight = DensityUtils.dip2px(8f);
    private int mLabelsPaddingBottom = DensityUtils.dip2px(4f);
    private int mLabelsPaddingLeft = DensityUtils.dip2px(8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = DensityUtils.dip2px(3f);
    ...
    private float mMenuShadowRadius = 3.6f;
    private float mMenuShadowXOffset = 0.6f;
    private float mMenuShadowYOffset = 1.6f;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMenuShadowColor = attr.getColor(R.styleable.FloatingActionMenu_menu_shadowColor, 0x26000000);
        ...
        mShowText = attr.getBoolean(R.styleable.FloatingActionMenu_menu_fab_showText, false);
        mTextColor = attr.getColor(R.styleable.FloatingActionMenu_menu_fab_textcolor, 0xFFFFFFFF);
        mTextSize = attr.getDimension(R.styleable.FloatingActionMenu_menu_fab_textsize, 12f);
        mText = attr.getString(R.styleable.FloatingActionMenu_menu_fab_text);
    ...
    public void setFabText(String text) {
        this.mText = text;
        mMenuButton.showText(mShowText);
        mMenuButton.setText(mText);
        mMenuButton.invalidate();
    }
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = DensityUtils.dip2px(mMenuShadowRadius);
            mMenuButton.mShadowXOffset = DensityUtils.dip2px(mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = DensityUtils.dip2px(mMenuShadowYOffset);
        }
        ...
        mMenuButton.showText(mShowText);
        mMenuButton.setText(mText);
        mMenuButton.setTextColor(mTextColor);
        mMenuButton.setTextSize(mTextSize);
