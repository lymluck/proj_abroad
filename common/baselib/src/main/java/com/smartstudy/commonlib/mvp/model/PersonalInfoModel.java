...
public class PersonalInfoModel {
    ...
    public static void sendMyInfo(final String qaId, final String commentId, BaseCallback<String> callback) {
        RequestManager.getInstance().doPost(new BaseRequestConfig() {
            @Override
            public String getUrl() {
                return HttpUrlUtils.getUrl(String.format(HttpUrlUtils.URL_SEND_TO_TEACHER, qaId, commentId));
            }
    ...
    public static void getUserInfo(final String userId, BaseCallback<String> callback) {
        RequestManager.getInstance().doGet(ParameterUtils.NETWORK_ELSE_CACHED, new BaseRequestConfig() {
            @Override
            public String getUrl() {
                return HttpUrlUtils.getUrl(String.format(HttpUrlUtils.URL_USER_INFO, userId));
            }
    ...
    private static Map params(PersonalParamsInfo personalParamsInfo) {
        ...
        if (personalParamsInfo.getBudget() != null) {
            params.put("budget", personalParamsInfo.getBudget());
        }
