...
public class ProgressPieView extends View {
    ...
    private static android.support.v4.util.LruCache<String, Typeface> sTypefaceCache = new android.support.v4.util.LruCache<String, Typeface>(8);
