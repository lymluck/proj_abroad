...
public class DeviceUtils {
    ...
    public static String getIdentifier() {
        TelephonyManager TelephonyMgr = (TelephonyManager) BaseApplication.appContext.getSystemService(Context.TELEPHONY_SERVICE);
        return TelephonyMgr.getDeviceId() == null ? "" : TelephonyMgr.getDeviceId(); // Requires READ_PHONE_STATE
    }
