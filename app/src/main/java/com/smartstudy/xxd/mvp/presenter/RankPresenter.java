...
public class RankPresenter implements RankContract.Presenter {
    ...
    @Override
    public void getRank(int cacheType, final String categoryId, final int page, final int request_state) {
        RankModel.getRank(cacheType, categoryId, page, new BaseCallback<String>() {
            @Override
