...
public class VisaQaPresenter implements VisaQaContract.Presenter {

    private VisaQaContract.View view;

    public VisaQaPresenter(VisaQaContract.View view) {
        this.view = view;
        this.view.setPresenter(this);
    }

    @Override
    public void getVisaQa(final String regionId) {
        VisaModel.getVisaQas(regionId, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                List<VisaQaInfo> data = JSON.parseArray(result, VisaQaInfo.class);
                if (data != null) {
                    view.showVisaQas(data);
                }
            }
        });
    }
