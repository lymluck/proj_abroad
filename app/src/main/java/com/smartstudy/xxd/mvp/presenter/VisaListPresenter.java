...
public class VisaListPresenter implements VisaListContract.Presenter {

    private VisaListContract.View view;

    public VisaListPresenter(VisaListContract.View view) {
        this.view = view;
    ...
    @Override
    public void getVisas(final String regionId) {
        VisaModel.getVisas(regionId, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                String str_visa = JSON.parseObject(result).getString("data");
                List<VisaInfo> data = JSON.parseArray(str_visa, VisaInfo.class);
                if (data != null) {
                    view.showVisas(data);
                }
            }
