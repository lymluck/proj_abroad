...
import com.smartstudy.xxd.mvp.model.GpaDescriptionModel;
...
public class GpaDescriptionPresenter implements GpaDescriptionContract.Presenter {

    private GpaDescriptionContract.View view;

    public GpaDescriptionPresenter(GpaDescriptionContract.View view) {
        this.view = view;
    ...
    @Override
    public void getGpaDescription() {
        GpaDescriptionModel.getGpaDescription(ParameterUtils.NETWORK_ELSE_CACHED, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                List<GpaCalculationDetail> data = JSON.parseArray(result, GpaCalculationDetail.class);
                if (data != null) {
                    view.showGpaDescription(data);
                }
            }
        });
    }
