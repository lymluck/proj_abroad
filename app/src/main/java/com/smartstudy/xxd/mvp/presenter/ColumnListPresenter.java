...
public class ColumnListPresenter implements ColumnListContract.Presenter {
    ...
    @Override
    public void getColumn(int page, final int request_state) {
        ColumnModel.getColumnList(page, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                ...
                List<ColumnListItemInfo> data = JSON.parseArray(dataListInfo.getData(), ColumnListItemInfo.class);
                dataListInfo = null;
                if (data != null) {
