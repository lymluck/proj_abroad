...
public interface QaListContract {
    ...
    interface View extends BaseView<QaListContract.Presenter> {
        ...
        void getMyQuestionSuccess(List<QuestionInfo> data, boolean hasUnreadQuestions, int request_stat);
    ...
    interface Presenter extends BasePresenter {
        ...
        void getRecommendQa(int cacheType, int page, int request_state);
