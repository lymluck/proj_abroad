...
public class CollegeDetailPresenter implements CollegeDetailContract.Presenter {
    ...
    private CollegeDetailContract.View view;
    ...
    public void getSchoolIntro(String schoolId) {
        SchoolModel.getCollegeIntro(schoolId, new BaseCallback<String>() {
            @Override
    ...
    public void getSchoolDetail(final String schoolId) {
        SchoolModel.getCollegeInfo(schoolId, new BaseCallback<String>() {
            @Override
            public void onErr(String errCode, String msg) {
                view.showTip(errCode, msg);
            }
    ...
    @Override
    public void postErr(String schoolId, String section, String content) {
        SchoolModel.postErr(schoolId, section, content, new BaseCallback<String>() {
            @Override
            public void onErr(String errCode, String msg) {
                view.showTip(errCode, msg);
            }
