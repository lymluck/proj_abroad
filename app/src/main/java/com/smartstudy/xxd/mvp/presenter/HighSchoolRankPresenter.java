...
import com.smartstudy.xxd.mvp.model.HighSchoolRankModel;
 ...
 */
public class HighSchoolRankPresenter implements HighSchoolRankContract.Presenter {

    private HighSchoolRankContract.View view;

    public HighSchoolRankPresenter(HighSchoolRankContract.View view) {
        this.view = view;
    ...
    @Override
    public void getHighRank() {
        HighSchoolRankModel.getHighRank(new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                ...
                List<HighSchoolRankInfo> data = JSON.parseArray(dataListInfo.getData(), HighSchoolRankInfo.class);
                dataListInfo = null;
                if (data != null) {
                    view.getHighRankSuccess(data);
                    data = null;
                }
            }
        });
