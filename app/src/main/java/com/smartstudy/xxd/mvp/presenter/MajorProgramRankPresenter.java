...
public class MajorProgramRankPresenter implements MarjorProgramRankContract.Presenter {

    private MarjorProgramRankContract.View view;

    public MajorProgramRankPresenter(MarjorProgramRankContract.View view) {
        this.view = view;
        this.view.setPresenter(this);
    }

    @Override
    public void getRank(int cacheType, String categoryId, int page, final int request_state) {
        MajorModel.getMajorProgramRankList(cacheType, categoryId, page, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                ...
                List<HomeHotProgramInfo> data = JSON.parseArray(dataListInfo.getData(), HomeHotProgramInfo.class);
                if (data != null) {
                    view.getRankSuccess(data, request_state);
                }
            }
        });
    }
