...
public class HotRankPresenter implements HotRankContract.Presenter {
    ...
    private HotRankContract.View view;

    public HotRankPresenter(HotRankContract.View view) {
        this.view = view;
        this.view.setPresenter(this);
    }

    @Override
    public void getRank(String flag) {
        RankModel.getHotRank(flag, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                List<HotRankInfo> datas = JSON.parseArray(result, HotRankInfo.class);
                if (datas != null) {
                    view.showList(datas);
                }
            }
