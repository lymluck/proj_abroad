...
import com.smartstudy.xxd.mvp.model.CommentModel;
 ...
 */
public class ColumnCommentPresenter implements ColumnCommentContract.Presenter {

    private ColumnCommentContract.View view;

    public ColumnCommentPresenter(ColumnCommentContract.View view) {
        this.view = view;
    ...
    @Override
    public void getColumnComments(String id, int page, final int request_state) {
        CommentModel.getColumnComments(id, page, new BaseCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                ...
                List<ColumnCommentInfo> data = JSON.parseArray(dataListInfo.getData(), ColumnCommentInfo.class);
                dataListInfo = null;
                if (data != null) {
                    view.showList(data, request_state);
                    data = null;
                }
            }
        });
    ...
    @Override
    public void comment(String newsId, String content, String commentId) {
        CommentModel.comment(newsId, content, commentId, new BaseCallback() {
            @Override
            public void onErr(String errCode, String msg) {
                view.showTip(errCode, msg);
            }
