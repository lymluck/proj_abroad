            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (info.getUrl() != null) {
                    if ("question".equals(info.getCollectType())) {
                        ...
                        toMoreDetails.putExtra(WEBVIEW_URL, info.getUrl());
                        toMoreDetails.putExtra(WEBVIEW_ACTION, "get");
                        startActivity(toMoreDetails);
                    }
                } else if ("highschool".equals(info.getCollectType())) {
                    startActivity(new Intent(MyCollectionActivity.this, HighSchoolDetailActivity.class)
                        .putExtra("id", info.getId() + ""));
                } else if ("columnNews".equals(info.getCollectType())) {
                    startActivity(new Intent(MyCollectionActivity.this, ColumnActivity.class)
                        .putExtra("id", info.getId() + ""));
                } else {
