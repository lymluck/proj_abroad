...
public class ThematicCenterActivity extends BaseActivity implements ThematicCenterContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UApp.actionEvent(this, "14_B_subject_list");
    }
    ...
    protected void initViewAndData() {
        ...
        //加载动画
        emptyView = mInflater.inflate(R.layout.layout_empty, rclvThematicCenter, false);
    ...
    private void initAdapter() {
        ...
        mAdapter.setOnItemClickListener(new CommonAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                UApp.actionEvent(ThematicCenterActivity.this, "14_A_subject_cell");
                ...
                toMoreDetails.putExtra(WEBVIEW_URL, info.getSubjectUrl());
