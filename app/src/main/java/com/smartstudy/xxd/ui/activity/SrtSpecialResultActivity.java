...
public class SrtSpecialResultActivity extends UIActivity implements SrtSpecialResultContract.View {
            ...
            protected void convert(ViewHolder holder, final SchoolInfo schoolInfo, final int position) {
                if (schoolInfo != null) {
                    if (schoolInfo != null) {
                        ...
                        holder.setText(R.id.tv_local_rank, String.format(getString(R.string.local_rank), schoolInfo.getLocalRank()));
    ...
    public void initEvent() {
        ...
        mAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                Intent toMoreDetails = new Intent(SrtSpecialResultActivity.this, SchoolDetailActivity.class);
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            case R.id.topdefault_leftbutton:
                ...
                break;
            case R.id.tv_share:
                ShareUtils.showShare(this, HttpUrlUtils.getWebUrl(HttpUrlUtils.URL_CHOOSE_SPEC), "智能选专业", "点击查看详细内容", null, null);
                break;
            case R.id.tv_add:
                showDialog(new View.OnClickListener() {
                    @Override
