...
public class ShowWebViewActivity extends UIActivity implements OnWebCommonListener {
    ...
    private ImageView topdefault_rgBtn;
    ...
    protected void initViewAndData() {
        topdefault_rgBtn = findViewById(R.id.topdefault_rightbutton);
        topdefault_rgBtn.setVisibility(View.VISIBLE);
        ...
        if ("homeTabNews".equals(flag)) {
            StatisticUtils.actionEvent(this, "18_B_news_detail");
        }
    ...
    public void initEvent() {
        ...
        topdefault_rgBtn.setOnClickListener(this);
    }
    ...
    protected void doClick(View v) {
        ...
        if (id == R.id.topdefault_leftbutton) {
            ...
            ShareUtils.showWebShare(this, webViewFragment.getWebUrl(),
                    topdefault_centertitle.getText().toString(), "点击查看更多", null, null);
        }
    }
