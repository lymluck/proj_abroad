...
public class SrtSchoolResultActivity extends BaseActivity implements SrtSchoolResultContract.View {
    ...
    protected void initViewAndData() {
        ...
        if (schoolInfo == null) {
            ...
            ToastUtils.showToast("抱歉，没有与你相匹配的院校哦~");
    ...
    public void initEvent() {
        ...
        mAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                Intent toMoreDetails = new Intent(SrtSchoolResultActivity.this, CollegeDetailActivity.class);
    ...
    public void goShare(String url, String title, String des) {
        UMShareUtils.showShare(this, url,
            title, des, null, new ShareListener(url, "result_smart_school"));
    }
