...
public class MainActivity extends UIActivity implements MainActivityContract.View {
    ...
    protected void initViewAndData() {
        ...
        if (getIntent().hasExtra("flag")) {
            ...
            if (flag == ParameterUtils.FRAGMENT_ONE) {
                ...
                mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_ONE);
            } else if (flag == ParameterUtils.FRAGMENT_TWO) {
                llyt_tab.setVisibility(View.GONE);
                mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_TWO);
            } else if (flag == ParameterUtils.FRAGMENT_THREE) {
                llyt_tab.setVisibility(View.GONE);
                mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_THREE);
            }
        } else {
            mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_ONE);
        }
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_tab_qa:
                controlDarkMode(true);
                mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_THOUR);
                break;
            case R.id.rlyt_me:
                controlDarkMode(true);
                mainP.showFragment(fragmentManager, ParameterUtils.FRAGMENT_FIVE);
                break;
            default:
                break;
        }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        mainP.showFragment(fragmentManager, savedInstanceState.getInt(ParameterUtils.FRAGMENT_TAG));
    ...
    public void hideFragment(FragmentTransaction ft) {
        ...
        if (schoolFragment != null) {
            ...
            schoolFragment.setUserVisibleHint(false);
        }
        if (courseListFragment != null) {
            tv_tab_course.setSelected(false);
            ft.hide(courseListFragment);
        ...
        if (qaFragment != null) {
            ...
            ft.hide(qaFragment);
            qaFragment.setUserVisibleHint(false);
        }
        if (meFragment != null) {
