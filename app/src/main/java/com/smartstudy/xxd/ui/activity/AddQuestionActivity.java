...
public class AddQuestionActivity extends UIActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatisticUtils.actionEvent(this, "20_B_question_post");
    }
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            case R.id.topdefault_leftbutton:
                StatisticUtils.actionEvent(this, "20_A_cancel_btn");
    ...
    private void addQuestion() {
        StatisticUtils.actionEvent(this, "20_A_post_btn");
        RequestManager.getInstance().doPost(new BaseRequestConfig() {
            ...
            public Map getParams() {
                ...
                params.put("content", etqa.getText().toString());
                return params;
            }
