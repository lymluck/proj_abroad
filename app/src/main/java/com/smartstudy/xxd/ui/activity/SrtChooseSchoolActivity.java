...
public class SrtChooseSchoolActivity extends UIActivity implements SrtChooseSchoolContract.View {
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_choose_school:
                if (country_id == null) {
                    ToastUtils.showToast(this, "请选择意向国家！");
                    break;
                }
                if (degreeId == null) {
                ...
                if ((TextUtils.isEmpty(et_test.getText()) || "0".equals(et_test.getText()))
                        && (TextUtils.isEmpty(et_eg.getText()) || "0".equals(et_eg.getText()))) {
