...
public class SchoolDetailActivity extends UIActivity implements SchoolDetailContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatisticUtils.actionEvent(this, "10_B_school_detail");
    }
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_more_intro:
                StatisticUtils.actionEvent(this, "10_A_intro_more_btn");
                //更多简介
            ...
            case R.id.ll_more_bk:
                StatisticUtils.actionEvent(this, "10_A_undergraduate_more_btn");
                //更多本科申请
            ...
            case R.id.ll_more_yjs:
                StatisticUtils.actionEvent(this, "10_A_graduate_more_btn");
                //更多研究生申请
            ...
            case R.id.ll_more_sia:
                StatisticUtils.actionEvent(this, "10_A_art_more_btn");
                //更多艺术生申请
            ...
            case R.id.ll_more_news:
                StatisticUtils.actionEvent(this, "10_A_news_more_btn");
                //更多资讯
            ...
            case R.id.ll_more_qa:
                StatisticUtils.actionEvent(this, "10_A_qustion_more_btn");
                //更多问答
                ...
                break;
            case R.id.tv_share:
                StatisticUtils.actionEvent(this, "10_A_share_btn");
            ...
            case R.id.tv_add:
                if (selected) {
                    ...
                    StatisticUtils.actionEvent(this, "10_A_add_btn");
                ...
                break;
            case R.id.tv_ask:
                StatisticUtils.actionEvent(this, "10_A_consul_btn");
                ...
                break;
            case R.id.tv_rate:
                StatisticUtils.actionEvent(this, "10_A_acceptance_rate_btn");
                ...
                protected void convert(ViewHolder holder, final QuestionInfo questionInfo, int position) {
                    if (questionInfo != null) {
                        ...
                        holder.getView(R.id.llyt_qa).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent toMoreDetails = new Intent(SchoolDetailActivity.this, QaDetailActivity.class);
