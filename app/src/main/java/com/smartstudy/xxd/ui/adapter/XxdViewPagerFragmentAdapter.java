...
public class XxdViewPagerFragmentAdapter extends FragmentPagerAdapter {
    ...
    public XxdViewPagerFragmentAdapter(FragmentManager fm, List<String> list, List<String> eventIds, List<UIFragment> fragments) {
        super(fm);
        this.titles = list;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        if (eventIds != null) {
            StatisticUtils.actionEvent(container.getContext(), eventIds.get(position));
        }
