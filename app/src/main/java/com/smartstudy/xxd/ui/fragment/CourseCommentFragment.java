...
public class CourseCommentFragment extends UIFragment implements CourseCommentContract.View {
    ...
    protected View getLayoutView() {
        return mActivity.getLayoutInflater().inflate(
                R.layout.fragment_course_comment, null);
    }

    @Override
    protected void initView(View rootView) {
        StatisticUtils.actionEvent(mActivity, "16_A_evaluation_btn");
    ...
    public void dialogComment() {
        ...
        dialog = DialogCreator.createCommentDialog(mActivity, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
