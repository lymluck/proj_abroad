...
public class PerfectUserInfoActivity extends UIActivity {
    ...
    public void initEvent() {
        ...
        optsInfoCommonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (opts != null) {
                    initParams(nowOpt, opts.getId(), opts.getName());
                    if (opts.isFinish()) {
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_country_diff:
                StatisticUtils.actionEvent(this, "4_A_compare_btn");
    ...
    private void actionEvent(PersonalParamsInfo info) {
        if ("STUDENT".equals(info.getCustomerRoleId())) {
            StatisticUtils.actionEvent(this, "2_A_student_btn");
        } else if ("PARENTS".equals(info.getCustomerRoleId())) {
            StatisticUtils.actionEvent(this, "2_A_ parents_btn");
        } else if ("OTHER".equals(info.getCustomerRoleId())) {
            StatisticUtils.actionEvent(this, "2_A_ other_btn");
        }

        int nowYear = DateTimeUtils.getNowYear();
        if (String.valueOf(nowYear).equals(info.getAdmissionTime())) {
            StatisticUtils.actionEvent(this, "3_A_first_btn");
        } else if (String.valueOf(nowYear + 1).equals(info.getAdmissionTime())) {
            StatisticUtils.actionEvent(this, "3_A_second_btn");
        } else if (String.valueOf(nowYear + 2).equals(info.getAdmissionTime())) {
            StatisticUtils.actionEvent(this, "3_A_third_btn");
        } else if ("OTHER".equals(info.getAdmissionTime())) {
            StatisticUtils.actionEvent(this, "3_A_other_btn");
        }
        SPCacheUtils.put("TARGE_COUNTRY", info.getTargetCountry());
        if ("COUNTRY_226".equals(info.getTargetCountry())) {
            StatisticUtils.actionEvent(this, "4_A_America_btn");
        } else if ("COUNTRY_225".equals(info.getTargetCountry())) {
            StatisticUtils.actionEvent(this, "4_A_England_btn");
        } else if ("COUNTRY_40".equals(info.getTargetCountry())) {
            StatisticUtils.actionEvent(this, "4_A_Canada_btn");
        } else if ("COUNTRY_16".equals(info.getTargetCountry())) {
            StatisticUtils.actionEvent(this, "4_A_Australia_btn");
        } else if ("OTHER".equals(info.getTargetCountry())) {
            StatisticUtils.actionEvent(this, "4_A_other_btn");
        }

        if ("DEGREE_MDT_BACHELOR".equals(info.getTargetDegree())) {
            StatisticUtils.actionEvent(this, "6_A_undergraduate_btn");
        } else if ("DEGREE_MDT_MASTER".equals(info.getTargetDegree())) {
            StatisticUtils.actionEvent(this, "6_A_graduate_btn");
        } else if ("DEGREE_MDT_OTHER".equals(info.getTargetDegree())) {
            StatisticUtils.actionEvent(this, "6_A_other_btn");
        }

        if ("30".equals(info.getTargetSchoolRank())) {
            StatisticUtils.actionEvent(this, "7_A_first_btn");
        } else if ("50".equals(info.getTargetSchoolRank())) {
            StatisticUtils.actionEvent(this, "7_A_second_btn");
        } else if ("100".equals(info.getTargetSchoolRank()) || "80".equals(info.getTargetSchoolRank())) {
            StatisticUtils.actionEvent(this, "7_A_third_btn");
        } else if ("OTHER".equals(info.getTargetSchoolRank())) {
            StatisticUtils.actionEvent(this, "7_A_other_btn");
        }
    }
    ...
    private void initParams(String opt, String id, String name) {
        if ("start".equals(opt)) {
            info.setCustomerRoleId(id);
            StatisticUtils.actionEvent(this, "2_B_user_identity");
        } else if ("step1".equals(opt)) {
            info.setAdmissionTime(id);
            SPCacheUtils.put("aboard_time", name);
            StatisticUtils.actionEvent(this, "3_B_abroad_time");
        } else if ("step2".equals(opt)) {
            StatisticUtils.actionEvent(this, "4_B_abroad_countries");
            info.setTargetCountry(id);
        } else if ("step3a".equals(opt) || "step3b".equals(opt)) {
            StatisticUtils.actionEvent(this, "6_B_programs");
            info.setTargetDegree(id);
            SPCacheUtils.put("project_name", name);
        } else if ("step4a".equals(opt) || "step4b".equals(opt)) {
            StatisticUtils.actionEvent(this, "7_B_school_rank");
            info.setTargetSchoolRank(id);
        } else if ("step5".equals(opt)) {
            info.setTargetMajorDirection(id);
        }
    }
