...
public class SplashActivity extends UIActivity implements SplashContract.View {
    ...
    protected void initViewAndData() {
        ...
        String imgUrl = (String) SPCacheUtils.get("adImg", "");
        if (!TextUtils.isEmpty(imgUrl)) {
            DisplayImageUtils.formatImgUrlNoHolder(this, imgUrl, iv_splash);
    ...
    public void initEvent() {
        ...
        iv_splash.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (!TextUtils.isEmpty(adUrl)) {
                    ...
                    Intent toMoreDetails = new Intent(SplashActivity.this, ShowWebViewActivity.class);
