...
public class SrtRateResultActivity extends UIActivity implements SrtRateResultContract.View {
    ...
    protected void doClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_rst_share:
                //分享
                ShareUtils.showShare(this, HttpUrlUtils.getWebUrl(String.format(HttpUrlUtils.URL_RESULT_RATE, id)),
                        "录取率测试结果", "点击查看详细内容", null, null);
                break;
