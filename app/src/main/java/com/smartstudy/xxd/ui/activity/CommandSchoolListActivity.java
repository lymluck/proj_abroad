...
public class CommandSchoolListActivity extends BaseActivity implements CommandSchoolListContract.View {
    ...
    public void initEvent() {
        ...
        mAdapter.setOnItemClickListener(new CommonAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                Intent toMoreDetails = new Intent(CommandSchoolListActivity.this, CollegeDetailActivity.class);
