...
public class NewsFragment extends UIFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isPrepared = true;
        StatisticUtils.actionEvent(mActivity, "17_B_news_list");
    }
    ...
    protected void initView(View rootView) {
        ...
        pager_news.setAdapter(new XxdViewPagerFragmentAdapter(getChildFragmentManager(), titles, eventIds, fragments));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.topdefault_rightmenu:
                StatisticUtils.actionEvent(mActivity, "17_A_search_btn");
