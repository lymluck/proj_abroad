...
public class MeFragment extends UIFragment implements MeFragmentContract.View {
    ...
    private LinearLayout llyt_study_time_planning;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isPrepared = true;
        StatisticUtils.actionEvent(mActivity, "22_B_my");
    }
    ...
    public void onFirstUserVisible() {
        ...
        if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
            ...
            if (!ParameterUtils.CACHE_NULL.equals(user_name) && !ParameterUtils.CACHE_NULL.equals(user_pic)
                ...
                DisplayImageUtils.displayPersonImage(mActivity, user_pic, iv_user_pic);
            ...
            DisplayImageUtils.displayImageRes(mActivity, R.drawable.rc_default_portrait, iv_user_pic);
    ...
    public void onUserVisible() {
        ...
        if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
            ...
            if (SPCacheUtils.get("TARGE_COUNTRY", "").equals("COUNTRY_226")) {
                llyt_study_time_planning.setVisibility(View.VISIBLE);
                rootView.findViewById(R.id.v_study_time_planning).setVisibility(View.VISIBLE);
            } else {
                llyt_study_time_planning.setVisibility(View.GONE);
    ...
    protected void initView(View rootView) {
        ...
        llyt_study_time_planning = rootView.findViewById(R.id.llyt_study_time_planning);
        llyt_study_time_planning.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.llyt_study_time_planning:
                StatisticUtils.actionEvent(mActivity, "22_A_abroad_plan_cell");
            ...
            case R.id.llyt_my_info:
                if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
                    StatisticUtils.actionEvent(mActivity, "22_A_userinfo_cell");
            ...
            case R.id.llyt_my_school:
                if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
                    StatisticUtils.actionEvent(mActivity, "22_A_my_schools_cell");
            ...
            case R.id.llyt_my_colllect:
                if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
                    StatisticUtils.actionEvent(mActivity, "22_A_my_favorit_cell");
            ...
            case R.id.llyt_my_qa:
                if (!ParameterUtils.CACHE_NULL.equals(ticket)) {
                    StatisticUtils.actionEvent(mActivity, "22_A_my_question_cell");
            ...
            case R.id.llyt_my_msg:
                StatisticUtils.actionEvent(mActivity, "22_A_my_message_cell");
            ...
            case R.id.rlyt_service:
                StatisticUtils.actionEvent(mActivity, "22_A_consult_cell");
            ...
            case R.id.llyt_setting:
                StatisticUtils.actionEvent(mActivity, "22_A_setting_cell");
                startActivity(new Intent(mActivity, SettingActivity.class));
                break;
            case R.id.tv_tf:
                goTools("com.smartstudy.zhantoefl", "http://a.app.qq.com/o/simple.jsp?pkgname=com.smartstudy.zhantoefl", "22_A_down_toefl_cell");
                break;
            case R.id.tv_ys:
                goTools("com.smartstudy.zhikeielts", "http://a.app.qq.com/o/simple.jsp?pkgname=com.smartstudy.zhikeielts", "22_A_down_ielts_cell");
                break;
            case R.id.tv_msk:
                goTools("com.smartstudy.zkmsk", "http://a.app.qq.com/o/simple.jsp?pkgname=com.smartstudy.zkmsk", "22_A_down_class_cell");
                break;
            default:
                break;
        }
        ...
        if (meP != null) {
            ...
            if (personalInfo != null) {
                if (personalInfo.getAvatar() != null) {
                    //图片裁剪
                    String url = Utils.getCacheUrl(personalInfo.getAvatar(), iv_user_pic.getWidth(), iv_user_pic.getHeight());
                    SPCacheUtils.put("user_pic", url);
                    if (mActivity != null && !mActivity.isFinishing()) {
                        DisplayImageUtils.displayPersonImage(mActivity, url, iv_user_pic);
                    }
                }
    ...
    private void goTools(String pgkName, String url, String eventId) {
        if (packageNames != null) {
            if (packageNames.contains(pgkName)) {
                ...
                StatisticUtils.actionEvent(mActivity, eventId);
            }
        }
    }
