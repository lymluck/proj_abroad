...
public class PersonalInfo {
    ...
    private boolean hasUnreadQuestions;
    ...
    public boolean isHasUnreadQuestions() {
        return hasUnreadQuestions;
    }

    public void setHasUnreadQuestions(boolean hasUnreadQuestions) {
        this.hasUnreadQuestions = hasUnreadQuestions;
    }
    ...
    public static class TargetSectionEntity {
        ...
        public static class BudgetEntity {

            /**
             * title : 资金预算
             * id :
             * name :
             * options : [{"id":"BUDGET_40W_RMB_PER_YEAR","name":"40万每年"},{"id":"BUDGET_30W_RMB_PER_YEAR","name":"30万每年"},{"id":"BUDGET_20W_RMB_PER_YEAR","name":"20万每年"},{"id":"BUDGET_10W_RMB_PER_YEAR","name":"10万每年"},{"id":"BUDGET_SCHOLARSHIP","name":"依赖奖学金"}]
             */
